...
| [`jimothy-android-1.0.29-gradle.apk`](dist/jimothy-android-1.0.29-gradle.apk) | Phone install with **closed-app alerts** (Gradle + NotificationScheduler) |
| [`jimothy-android-1.0.29-gradle.aab`](dist/jimothy-android-1.0.29-gradle.aab) | Play Console bundle (`com.jimothypet.app`, versionCode 29, **no `USE_EXACT_ALARM`**). Re-sign with your upload keystore — see godot/README.md |
...
**Phone + closed-app alerts:** install the prebuilt [`dist/jimothy-android-1.0.29-gradle.apk`](dist/jimothy-android-1.0.29-gradle.apk) (Godot-on-phone exports usually miss the scheduler plugin). See [`godot/README.md`](godot/README.md). Web needs a user tap to allow notifications on phones. Preference is saved.
